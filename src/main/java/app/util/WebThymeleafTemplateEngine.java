 ...
 */
public class WebThymeleafTemplateEngine extends TemplateEngine {
     ...
     */
    public WebThymeleafTemplateEngine() {
     ...
     */
    public WebThymeleafTemplateEngine(String prefix, String suffix) {
     ...
     */
    public WebThymeleafTemplateEngine(ITemplateResolver templateResolver) {
    ...
    public String render(ModelAndView modelAndView, Locale locale) {
        WebModelAndView webModelAndView = (WebModelAndView)modelAndView;

        Object model = webModelAndView.getModel();
        ...
        if (model instanceof Map) {
            WebContext context = new WebContext(
                    webModelAndView.getRequest().raw(),
                    webModelAndView.getResponse().raw(),
                    webModelAndView.getRequest().raw().getServletContext());
            return templateEngine.process(webModelAndView.getViewName(), context);
        } else {
